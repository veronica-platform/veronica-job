...
import static ec.veronica.job.types.DestinationFolderType.FOLDER_AUTHORIZED;
import static ec.veronica.job.types.DestinationFolderType.FOLDER_INBOX;
import static ec.veronica.job.types.DestinationFolderType.FOLDER_PENDING;
import static ec.veronica.job.types.DestinationFolderType.FOLDER_PROCESSING_ERROR;
import static ec.veronica.job.types.DestinationFolderType.FOLDER_REJECTED;
import static ec.veronica.job.types.DestinationFolderType.FOLDER_UNAUTHORIZED;
